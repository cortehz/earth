    ...
    ocean_salinity: {
      ...
      create: function (attr) {
        return buildProduct({
          ...
          scale: {
            bounds: [
              scales === null || undefined ? 30 : Number(scales.startScale),
              scales === null || undefined ? 38 : Number(scales.stopScale),
            ],
            gradient: µ.segmentedColorScale(
              activeGradient !== null && activeGradient.length > 0
                ? activeGradient
                : [
                    [30, [52, 68, 155]],
                    [30.5, [55, 72, 159]],
    ...
    otemperature: {
      ...
      create: function (attr) {
        return buildProduct({
          ...
          scale: {
            bounds: [
              scales === null || undefined ? -5 : Number(scales.startScale),
              scales === null || undefined ? 30 : Number(scales.stopScale),
            ],
            gradient: µ.segmentedColorScale(
              activeGradient !== null && activeGradient.length > 0
                ? activeGradient
